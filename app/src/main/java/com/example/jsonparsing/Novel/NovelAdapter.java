...
public class NovelAdapter extends RecyclerView.Adapter<NovelAdapter.MyViewHolder> {
    ...
    public NovelAdapter(Context context, ArrayList<NovelModel> arrayList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.novel_item_row,parent,false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
    NovelModel model= arrayList.get(position);
        ...
        holder.t2.setText(model.getAuthor());
