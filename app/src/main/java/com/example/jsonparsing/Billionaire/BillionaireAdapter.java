...
public class BillionaireAdapter extends RecyclerView.Adapter<BillionaireAdapter.MyViewHolder>{
    Context context;
    ArrayList<BillionaireModel> arrayList;

    public BillionaireAdapter(Context context, ArrayList<BillionaireModel> arrayList) {
    ...
    BillionaireModel model =arrayList.get(position);
    ...
    holder.t9.setText(""+(position+1));
    holder.cardView.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View view) {
                Intent intent = new Intent(context, BillionaireViewActivity.class);
