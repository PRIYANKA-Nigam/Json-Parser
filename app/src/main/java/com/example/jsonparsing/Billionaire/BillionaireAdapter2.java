...
public class BillionaireAdapter2 extends RecyclerView.Adapter<BillionaireAdapter2.MyViewHolder>{
    Context context;
    ArrayList<BillionaireModel2> arrayList;
    public BillionaireAdapter2(Context context, ArrayList<BillionaireModel2> arrayList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        BillionaireModel2 model =arrayList.get(position);
